<style>
    ...
    .logo-pc {
        ...
        left: 590px; /* Ajusta la posición horizontal del logo */
...
<div class="cabecera-pc">
    <img src="img/PC/LOGO-PC.png" alt="Logo PC" class="logo-pc">
    <h1 class="titulo-pc">PC</h1>
</div>
<main>
    <section class="pc-list">
        <article class="game-pc">          
            <img src="img/PC/PC-GAME1.png" alt=""/>
            <h2>HALO</h2>
            <p>Precio: S/179.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME2.png" alt=""/>
            <h2>LEFT 4 DEAD 2</h2>
            <p>Precio: S/19.90</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME3.png" alt=""/>
            <h2>PAYDAY 2</h2>
            <p>Precio: S/108.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME4.png" alt=""/>
            <h2>COD BLACKOPS</h2>
            <p>Precio: S/148.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME5.png" alt=""/>
            <h2>CS GO</h2>
            <p>Precio: S/89.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME6.png" alt=""/>
            <h2>GTA IV</h2>
            <p>Precio: S/49.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME7.png" alt=""/>
            <h2>MORTAL KOMBAT X</h2>
            <p>Precio: S/139.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME8.png" alt=""/>
            <h2>INJUSTICE 2</h2>
            <p>Precio: S/109.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME9.png" alt=""/>
            <h2>HELLBLADE</h2>
            <p>Precio: S/50.00</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
        <article class="game-pc">
            <img src="img/PC/PC-GAME10.png" alt=""/>
            <h2>PES 2021</h2>
            <p>Precio: S/59.90</p>
            <button onclick="agregarAlCarrito(this)">Agregar al carrito</button>
        </article>
